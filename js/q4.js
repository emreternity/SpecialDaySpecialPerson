...
var duckaud = new Audio(
  "../audio/y2mate.com - sarhoş talisca  baba ben senin için dünyayı değişmem asla orijinal video.mp3"
);
...
function wrongbtn() {
  ...
  setTimeout(function () {
    ...
    question.text("Beyza'nın gizli yeteneği nedir?");
